...
const AuthLayout = ({ children }) => {
  return (
    <div className="flex">
      ...
      {/* RIGHT SIDE */}
      <div className="hidden md:block relative w-[40vw] h-screen bg-violet-50 bg-auth-bg-img bg-cover bg-no-repeat bg-center p-8">
        {/* BACKGROUND SHAPES */}
        ...
        <img
          src={CARD_2}
          alt="Card"
          className="w-64 lg:w-[90%] absolute bottom-10 right-5 z-20 shadow-lg shadow-blue-400/15"
        />
      </div>
    </div>
  );
...
const StatsInfoCard = ({ icon, label, value, color }) => {
  return (
    <div className="flex gap-6 bg-white p-4 rounded-xl shadow-md shadow-purple-400/10 border border-gray-200 z-30">
      <div
